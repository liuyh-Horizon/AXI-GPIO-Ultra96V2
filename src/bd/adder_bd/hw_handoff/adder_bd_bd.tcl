...
################################################################
# This is a generated script based on design: adder_bd
#
...
if { $run_remote_bd_flow == 1 } {
  ...
  set origin_dir ./Projects/Hardware/FPGA/Ultra96V2/AXI-GPIO/src/bd
...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net Adder_0_out [get_bd_pins Adder_0/adder_out] [get_bd_pins axi_gpio_0/gpio_io_i]
  connect_bd_net -net axi_gpio_1_gpio_io_o [get_bd_pins Adder_0/in_0] [get_bd_pins axi_gpio_1/gpio_io_o]
  connect_bd_net -net axi_gpio_2_gpio_io_o [get_bd_pins Adder_0/in_1] [get_bd_pins axi_gpio_2/gpio_io_o]
  connect_bd_net -net rst_ps8_0_100M_peripheral_aresetn [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_gpio_1/s_axi_aresetn] [get_bd_pins axi_gpio_2/s_axi_aresetn] [get_bd_pins ps8_0_axi_periph/ARESETN] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/M01_ARESETN] [get_bd_pins ps8_0_axi_periph/M02_ARESETN] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps8_0_100M/peripheral_aresetn]
