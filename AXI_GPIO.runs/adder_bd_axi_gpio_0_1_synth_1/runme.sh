...
HD_PWD='/home/yuhao_liu/Projects/Hardware/FPGA/Ultra96V2/AXI-GPIO/AXI_GPIO.runs/adder_bd_axi_gpio_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log adder_bd_axi_gpio_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source adder_bd_axi_gpio_0_1.tcl
