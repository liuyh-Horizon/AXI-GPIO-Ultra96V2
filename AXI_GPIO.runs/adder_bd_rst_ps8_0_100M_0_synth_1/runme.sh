...
HD_PWD='/home/yuhao_liu/Projects/Hardware/FPGA/Ultra96V2/AXI-GPIO/AXI_GPIO.runs/adder_bd_rst_ps8_0_100M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log adder_bd_rst_ps8_0_100M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source adder_bd_rst_ps8_0_100M_0.tcl
