...
HD_PWD='/home/yuhao_liu/Projects/Hardware/FPGA/Ultra96V2/AXI-GPIO/AXI_GPIO.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log adder_bd_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source adder_bd_wrapper.tcl -notrace
